...
void GamePlay::Init()
{
	m_context->m_assets->addTexture(GRASS, "AssetFile/textures/grass3.png", true);
	m_context->m_assets->addTexture(FOOD, "AssetFile/textures/food.png");
	m_context->m_assets->addTexture(SNAKE, "AssetFile/textures/snake.png");
	m_context->m_assets->addTexture(WALL, "AssetFile/textures/wall.png", true);
	...
	int a = m_context->m_window->getSize().x;
	int b = (int)m_context->m_window->getSize().y;
	m_walls[0].setTextureRect({ 0, 0, a, 16});
	m_walls[1].setTextureRect({ 0, 0, a, 16 });
	m_walls[1].setPosition(0, m_context->m_window->getSize().y - 16);

	m_walls[2].setTextureRect({ 0, 0, 16, b });
	m_walls[3].setTextureRect({ 0, 0, 16, b });
